...
def gload_credentials():
    lines = [line.rstrip('\n') for line in open('geniuscredentials.ini')]
    chars_to_strip = " \'\""
    for line in lines:
...
client_id, client_secret, client_access_token = gload_credentials()
def GeniusSearchLyrics(search_term):
